...
@section('content')
    <main>
        ...
        @include('front.layouts.sub-header', [ 'page_heading' => 'Invest <span class="fw-normal">in jeeni</span>'])

        <!-- Content after the title -->
            <div class="row pb-3 pb-md-5">
                <!-- Left col -->
                <div class="col-12 col-md-6 py-3 my-0">
                        ...
                        <div class="video-player-container">
                            <div class="video-container" id="video-container">
                                ...
                                <video controls class="video" id="video" preload="metadata"
                                       poster="{{ \App\Helpers\HomePageHelper::getConfigurationData('site.invest_left_video_thumb') }}">
                                    <source
                                        src="{{ \App\Helpers\HomePageHelper::getConfigurationData('site.invest_left_video_link') }}"
                                        type="video/mp4">
                                    </source>
                                </video>
                                        ...
                                        <div class="right-controls d-flex">
                                            ...
                                            <div class="volume-controls">
                                                ...
                                                <input class="volume" id="volume" value="1" data-mute="0.5" type="range"
                                                       max="1"
                                                       min="0" step="0.01" style="position: absolute">
                                            </div>
                                            <!-- // Volume -->
                    ...
                    <h5 class="text-truncate mt-3">
                        {{ \App\Helpers\HomePageHelper::getConfigurationData('site.invest_left_video_sub_title') }}
                    </h5>
                </div>
                <!-- // Left col -->
                ...
                <div class="col-12 col-md-6 py-3 my-0">
                    <div class="px-0">
                        <div class="col">
                            <iframe class="video-iframe" src="{{ url('invest-right') }}"
                                    width="100%" height="101%"
                                    style="border:none; overflow: hidden; overflow: hidden; width: 100%; min-height:365px; height: 100%;">
                            </iframe>
                            <h5 class="text-truncate">
                                {{ \App\Helpers\HomePageHelper::getConfigurationData('site.invest_right_sub_title') }}
                            </h5>
                        </div>
                    </div>
                </div>
...
@section('footer_script')
    <script>
        ...
        function adjustHeight() {
            let height = parseInt($('.video-player-container').height()) + 10;
            $('iframe.video-iframe').css('min-height', height + 'px');
        }
    </script>
@endsection
