...
class VoyagerTrackController extends BaseVoyagerBaseController {
    ...
    protected function browse(Request $request) {
        ...
        if (strlen($dataType->model_name) != 0) {
            ...
            return Datatables::of($query)
                ...
                ->editColumn('showcase_id', function($query) {
                    if($query->showcase instanceof Showcase) {
                        return $query->showcase->title;
                    } else {
                        return $query->showcase_id;
                    }
                })
    ...
    public function store(Request $request)
    {
        ...
        $data = Track::create([
            ...
            'track_file' => $request->get('track_file'),
