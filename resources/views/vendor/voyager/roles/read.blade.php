    ...
    <div class="page-content read container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel panel-bordered" style="padding-bottom:5px;">
                    <div class="panel-heading" style="border-bottom:0;width: 100%;">
                                    ...
                                    <tr class="parent">
                                        <td>
                                            @if(count($item['children']) > 0)
                                                <a href="#" class="parent-control" data-id="{{ $item['id'] }}"><i class="fas fa-minus-circle"></i></a>
                                            @endif
                                            {{ $item['title'] }}
                                        </td>
                                        <td></td>
                                        @forelse ($item['permission_keys'] as $key)
                                            <td class="text-center">
                                                {!!  (isset($rolePermissions) && in_array($key, $rolePermissions))
                                                    ? '<span class="btn btn-success">Y</span>' : '<span class="btn btn-danger">N</span>' !!}
                                            </td>
                                        @empty
                                            <td>&nbsp;</td>
                                            <td>&nbsp;</td>
                                    ...
                                    @forelse ($item['children'] as $children)
                                        <tr class="children children-{{ $item['id'] }}">
                                            ...
                                            @forelse ($children['permission_keys'] as $childKey)
                                                <td class="text-center">
                                                    {!!  (isset($rolePermissions) && in_array($childKey, $rolePermissions))
                                                        ? '<span class="btn btn-success">Y</span>' : '<span class="btn btn-danger">N</span>' !!}
                                                </td>
