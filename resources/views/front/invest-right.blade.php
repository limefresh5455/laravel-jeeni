...
<head>
    ...
    <title>Right media player</title>
    <!-- Bootstrap -->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet"
          crossorigin="anonymous"/>
    <!-- Custom css -->
    <link href="{{ asset('front/css/invest-in-jeeni-media-style.css') }}" rel="stylesheet"/>
</head>
    ...
    <div class="video-player-container">
        <div class="video-container" id="video-container">
            ...
            <video controls class="video" id="video" preload="metadata"
                   poster="{{ \App\Helpers\HomePageHelper::getConfigurationData('site.invest_right_video_thumb') }}">
                <source src="{{ \App\Helpers\HomePageHelper::getConfigurationData('site.invest_right_video_link') }}"
                        type="video/mp4">
                </source>
            </video>
...
<script src="{{ asset('front/js/invest-in-jeeni-media-script.js') }}"></script>
</body>
